...
out.writerow(['Reference', 'Quantity', 'Value', 'Digi-Key Part #'])

# Get all of the components in groups of matching parts + values
# (see ky_generic_netlist_reader.py)
grouped = net.groupComponents(net.getDigiKeySplitComponents())
...
for group in grouped:
    ...
    out.writerow([refs, len(group), c.getValue(), c.getDigiKey()])
